...
#define SCREENWID (TILEWID * GRIDWID) * 2

#define SCREENHGT (TILEHGT * GRIDHGT) * 2
...
#define LEV1_ROOM_MINX 24

#define LEV1_ROOM_MAXX 30

#define LEV1_ROOM_MINY 8

#define LEV1_ROOM_MAXY 14

#define NUM_TOTAL_TERRAIN 19

#define NUM_TOTAL_ITEMS 70

#define NUM_TOTAL_FEATURES 1

#define NUM_TOTAL_BEINGS 30

#define NUM_TOTAL_FIRE 38

#define NUM_REGULAR_LEVELS 30

#define NUM_ITEM_CATEGORIES 10

#define NUM_TOTAL_SLOT_TILES 12

#define WEAPON_OFFSET 2

#define ARMOR_OFFSET 61

#define DEVICE_OFFSET 54

#define NUM_TOTAL_WEAPONS 20

#define NUM_TOTAL_ARMORS 5

#define NUM_TOTAL_DEVICES 7

#define NUM_TOTAL_MELEE_WEAPONS 6

#define MAX_EXP_LEVEL 70

#define STRING std::string

#define VECTOR std::vector

#define INT_BOOL_MAP std::map<int, bool>

#define INT_INT_MAP std::map<int, int>
...
struct IdentificationData {
    INT_BOOL_MAP discoveryMap;
    INT_INT_MAP identificationMap;
};
...
static const color_type color_gray = {196,196,196};

static const color_type color_wallgray = {196,196,196};
...
static const chtype symbol_NPC[NUM_TOTAL_BEINGS] =
{
    ...
    { {color_darkgray, color_black}, (int)'@'},
    { {color_gray, color_black}, (int)'R' },
    { {color_red, color_black}, (int)'@' },
    { {color_darkgray, color_black}, (int)'b'},
    { {color_green, color_black}, (int)'m'},
